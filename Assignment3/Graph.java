/* The graph data structure and method class,
it takes the nodes and edge values as input, 
and output three tables
*/
...
public class Graph{
    ...
    */
    ...
    /*Adapt from: https://www.mathcs.emory.edu/~cheung/Courses/171/Syllabus/11-Graph/dijkstra2.html
     This function takes one method and calcute the shortest path to next hop
     Used Dynamic Programming to store the shortest path value   
    */
    public void Dijkstra(Object node)
    {
      ...
      //dijkstra algo
       ...
       int n =0;
        ...
        for ( int i =0; i< numNodes ;i ++ ) {
            //distance[n] = length of shortest path s ->n
            distance[i] = linkCost[source][i];
